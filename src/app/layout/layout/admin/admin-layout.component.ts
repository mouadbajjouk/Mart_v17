...
import { AppAdminFooter } from './components/admin-footer';
...
export class AdminLayoutComponent {
  ...
  @ViewChild(AppAdminSidebar) appSidebar!: AppAdminSidebar;

  @ViewChild(AppAdminTopbar) appTopBar!: AppAdminTopbar;
